		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','job_number') || $check_field('add','job_number') || $check_field('set','job_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="工号" prop="job_number">
					<el-input id="job_number" v-model="form_sub['job_number']" placeholder="请输入工号"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','job_number')) || (!form_sub['teacher_user_id'] && $check_field('add','job_number'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','title') || $check_field('add','title') || $check_field('set','title')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="职称" prop="title">
					<el-input id="title" v-model="form_sub['title']" placeholder="请输入职称"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','title')) || (!form_sub['teacher_user_id'] && $check_field('add','title'))"></el-input>
					<div v-else-if="$check_field('get','title')">{{form_sub['title']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
